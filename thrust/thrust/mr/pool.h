...
private:
  ...
  using block_descriptor_ptr = typename ::cuda::std::pointer_traits<void_ptr>::template rebind<block_descriptor>;
  using chunk_descriptor_ptr = typename ::cuda::std::pointer_traits<void_ptr>::template rebind<chunk_descriptor>;
  using oversized_block_descriptor_ptr =
    typename ::cuda::std::pointer_traits<void_ptr>::template rebind<oversized_block_descriptor>;
